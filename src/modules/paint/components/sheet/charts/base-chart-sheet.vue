<template>
  <div>
    <el-form ref="form"  label-width="110px">
      ...
      <el-form-item label="xAxisField：">
        <el-input v-model.trim="node.xAxisField"></el-input>
      </el-form-item>
    </el-form>
    ...
    <div class="item-container">
      ...
      <el-table :data="node.data" border style="width: 100%">
        <el-table-column :prop="node.xAxisField" label="xAxis"></el-table-column>
        <el-table-column 
