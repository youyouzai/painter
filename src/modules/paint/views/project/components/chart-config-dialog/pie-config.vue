  ...
  <el-dialog
    ...
    <div class="content">
      <div class="item-container">
        <div class="title">数据项配置<el-button
            v-if="node.series.length === 0"
            type="primary"
            icon="el-icon-plus"
            circle
            size="mini"
        ...
        <el-table :data="node.series" border style="width: 100%">
          ...
          <el-table-column label="操作" width="100">
            <template slot-scope="scope">
              <el-button type="primary" icon="el-icon-plus" circle size="mini" @click="onAddSerieClick(scope.$index + 1)"></el-button>
              <el-button type="danger" icon="el-icon-minus" circle size="mini" @click="onDeleteSerieClick(scope.$index)"></el-button>
            </template>
          </el-table-column>
        </el-table>
      </div>
